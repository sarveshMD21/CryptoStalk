...
const NavbarDrawer = () => {
  const open=useSelector((state)=>state.toggle.navbar);
  ...
  return (
    ...
    >
        <div className='flex flex-col w-48 h-full dark:bg-black dark:text-white dark:border-l-2 dark:border-blue-600 p-5 lg-custom:hidden'>
            ...
            <div className='flex justify-center mt-5 mb-5'><MaterialUISwitch   checked={checked} onChange={handleClick}/></div>
        </div>
    </Drawer>
